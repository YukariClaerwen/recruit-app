...
export default function Dialog({ title, onClose, children, onShow, onSave, btn }) {
                            ...
                            <div className="modal-header">
                                ...
                                <form noValidate>
                                    ...
                                    <div className="modal-footer">
                                        <button type="button" className="btn btn-secondary" onClick={closeDialog}>Bỏ qua</button>

...
const AddCompany = (props) => {
    ...
    const onSubmit = async (value) => {
        ...
        if (isSuccessLogo || isSuccessCover) {
            toast({
                title: "Lỗi!",
                description: <p>Vui lòng upload logo trước!</p>,
                variant: 'destructive',
            })
            return null
        }
                    ...
                    <div className="space-y-6">
                        <div>
                            <FormGroup controlId="cover" className="mb-3">
                                <FormLabel className="bg-white hover:bg-fuchsia-200 border-dotted border-2 rounded w-full h-[10rem] relative flex justify-center items-center overflow-hidden">
                                    <div className={` flex justify-center items-center flex-col gap-2 ${isPreviewCover || isUploadedCover || selectedLogo ? "hidden" : ""}`}>
                        ...
                        <div className="flex gap-4">
                            <div className="lg:w-1/3 w-full">
                                <FormGroup controlId="logo" className="mb-3">
                                    <FormLabel className="bg-white hover:bg-fuchsia-200 border-dotted border-2 rounded w-full h-[16rem] relative flex justify-center items-center">
